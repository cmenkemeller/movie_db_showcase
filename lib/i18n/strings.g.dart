...
///
/// Built on 2024-06-09 at 03:10 UTC
...
class _StringsEs implements Translations {
	...
	// Translations
	@override String get appName => 'App de Movies DB';
	@override String get findYourMovies => 'Encuentra tus películas';
	@override String get title => 'Título';
	@override String get releaseDate => 'Fecha de Lanzamiento';
	@override String get averageRating => 'Calificación Promedio';
	@override String get searchHere => 'Buscar aquí';
	@override String get overview => 'Resumen';
	@override String get popularity => 'Popularidad';
	@override String get voteCount => 'Conteo de Votos';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'appName': return 'Movies DB App';
			case 'findYourMovies': return 'Find your movies';
			case 'title': return 'Title';
			case 'releaseDate': return 'Release Date';
			case 'averageRating': return 'Average Rating';
			case 'searchHere': return 'Search here';
...
extension on _StringsEs {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			case 'appName': return 'App de Movies DB';
			case 'findYourMovies': return 'Encuentra tus películas';
			case 'title': return 'Título';
			case 'releaseDate': return 'Fecha de Lanzamiento';
			case 'averageRating': return 'Calificación Promedio';
			case 'searchHere': return 'Buscar aquí';
			case 'overview': return 'Resumen';
			case 'popularity': return 'Popularidad';
			case 'voteCount': return 'Conteo de Votos';
